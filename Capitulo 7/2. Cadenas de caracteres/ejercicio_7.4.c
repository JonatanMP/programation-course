...
void main(void)
{
    ...
    cad0 = "Brasil"; //correcto. modifica el contenido de la direccion de memoria a la que apunta cad0 ya que es un apuntaddor.
    puts(cad0);
    ...
    char cad1[]; //incorrecto. genera un error al compilar, porque no se reserva el espacio correspondiente.
